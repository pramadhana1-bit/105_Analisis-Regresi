...
data <- read_xlsx ("C:\\Users\\Roshan\\OneDrive\\Documents\\Kuliah\\ANREG\\NSC-2025.xlsx")
...
$$\hat{Y} = -10.70937 + 0.93793 X_7$$

dengan Y adalah persentase penduduk miskin dan X7 adalah persentase akses sanitasi layak.

Didapatkan nilai $\hat\beta_0 = -10.70937$ artinya nilai dugaan rataan indeks pembangunan manusia ketika Indeks Pembangunan Gender bernilai 0 persen adalah -10.70%, akan tetapi nilai 0 tidak ada dalam selang pengamatan Indeks Pembangunan Gender sehingga $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut

Nilai $\hat\beta_1 = 0.93793$ artinya nilai dugaan perubahan dugaan rataan Indeks Pembangunan Manusia jika Indeks Pembangunan Gender berubah satu tahun adalah sebesar 0,937%

Koefisien determinasi yang dihasilkan adalah 0.5108 atau 51.08% artinya keragaman persentase penduduk miskin yang dapat dijelaskan oleh persentase Indeks Pembangunan Gender adalah sebesar 51.08%, sisanya yaitu 48.92% dijelaskan oleh peubah lain yang tidak dimasukkan dalam model.
